...
export class InitDb1724758379828 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`applications\` (\`id\` int NOT NULL AUTO_INCREMENT, \`firstName\` varchar(255) NOT NULL DEFAULT '', \`lastName\` varchar(255) NOT NULL DEFAULT '', \`dateOfBirth\` timestamp NULL, \`city\` varchar(255) NOT NULL DEFAULT '', \`region\` varchar(255) NOT NULL DEFAULT '', \`phoneNumber\` varchar(255) NOT NULL DEFAULT '', \`guardianFullName\` varchar(255) NOT NULL DEFAULT '', \`guardianPhoneNumber\` varchar(255) NOT NULL DEFAULT '', \`relationshipWithGuardian\` varchar(255) NOT NULL DEFAULT '', \`specialConditions\` text NULL, \`highschool\` varchar(255) NOT NULL DEFAULT '', \`averageGrade\` varchar(255) NOT NULL DEFAULT '', \`ranking\` varchar(255) NOT NULL DEFAULT '', \`hasPreviouslyParticipated\` varchar(255) NOT NULL DEFAULT '', \`previousCompetitions\` text NULL, \`comments\` text NULL, \`schoolCertificateUrl\` varchar(255) NULL, \`gradesUrl\` varchar(255) NULL, \`regulationsUrl\` varchar(255) NULL, \`parentalAuthorizationUrl\` varchar(255) NULL, \`massarCode\` varchar(255) NOT NULL DEFAULT '', \`parentCNIE\` varchar(255) NOT NULL DEFAULT '', \`physicsAverageGrade\` varchar(255) NOT NULL DEFAULT '', \`physicsRanking\` varchar(255) NOT NULL DEFAULT '', \`physicsOlympiadsParticipation\` varchar(255) NOT NULL DEFAULT '', \`olympiadsTrainingSelection\` varchar(255) NOT NULL DEFAULT '', \`parentIdUrl\` varchar(255) NULL, \`birthCertificateUrl\` varchar(255) NULL, \`imageRightsUrl\` varchar(255) NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` int NULL, \`statusId\` int NULL, UNIQUE INDEX \`REL_90ad8bec24861de0180f638b9c\` (\`userId\`), UNIQUE INDEX \`REL_2ccfa45ebf6c44b5f26a1a87ff\` (\`statusId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`
      INSERT INTO \`admin_users\` (\`username\`, \`password\`) VALUES ('admin', '$2b$10$eHHTfwOLQKVvJYDjjp.AeuBeTH9qilwSlVekx.wLAWxcUyvufNSuu')
    `);
