  ...
  return (
    <div className="w-full max-w-sm md:max-w-5xl px-5 xl:px-0 mt-10">
      <div className="space-y-6">
        ...
        >
          <p className="mt-12">
            Découvrez comment s&apos;est déroulée la dernière édition de <span className='bg-gradient-to-br from-sky-500 to-[#272162] inline-block text-transparent bg-clip-text'>FMA</span> au Lycée Mohamed 6 d&apos;Excellence de Benguerir, avec des participants venus de tous les coins du Maroc pour démontrer leurs compétences dans le cadre d&apos;une compétition de recherche de haut niveau valorisant la bienveillance entre les compétiteurs.  
          </p>

          <p className="mt-12">
            Les problèmes proposés à <span className='bg-gradient-to-br from-sky-500 to-[#272162] inline-block text-transparent bg-clip-text'>FMA</span> sont très stimulants et nécessitent une bonne maîtrise des bases mathématiques et physiques, puisqu&apos;ils sont conçus pour aider à développer l&apos;esprit de recherche chez les lycéens.  
          </p>

          <p className="mt-6">
            Besoin de plus d&apos;idées sur le type de problèmes à <span className='bg-gradient-to-br from-sky-500 to-[#272162] inline-block text-transparent bg-clip-text'>FMA</span> ? Ici tu trouveras tout pour assouvir ta curiosité !
          </p>
        </div>
